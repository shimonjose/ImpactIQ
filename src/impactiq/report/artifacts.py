...
Design rule ("deterministic core stays deterministic"): the agent *drafts* an
artifact payload, but every payload passes through
...
record. Execution (tap/typed confirm, OBO write, audit chain) arrives with
the Teams surface.
"""
