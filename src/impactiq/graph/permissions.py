...
Live FLS detection (secured-attribute metadata + the user's FSP membership via
teams) is not implemented; the limitation is stated here deliberately rather
than faked or silently implied by the walk order above.
"""
...
class PrivilegeFetchError(RuntimeError):
    ...
    converted into a false 'permission denied'."""
