...
def build_engine_tool_specs(ctx: ToolContext) -> dict[str, EngineToolSpec]:
    ...
    walk_anchor_spec = EngineToolSpec(
        name="walk_anchor",
        description=(
            "Walk the dependency neighbourhood around an anchor (both "
    ...
    retrieve_dependent_spec = EngineToolSpec(
        ...
        description=(
            "Downstream - components that DEPEND ON (object_id, "
    ...
    retrieve_required_spec = EngineToolSpec(
        ...
        description=(
            "Upstream - components this one DEPENDS ON. Use when probing "
    ...
    retrieve_for_delete_spec = EngineToolSpec(
        ...
        description=(
            "Delete-blockers - what would prevent removing this "
    ...
    recent_change_spec = EngineToolSpec(
        ...
        description=(
            "Estate-side change-collision scan - recently-edited "
    ...
    diagnose_permission_spec = EngineToolSpec(
        ...
        description=(
            "Permissions diagnosis - why can/can't a user perform an "
    ...
    score_risk_spec = EngineToolSpec(
        name="score_risk",
        description=(
            "Explainable risk scorer. Counts CAUSAL "
    ...
    find_failed_flows_spec = EngineToolSpec(
        ...
        description=(
            "List recent FAILED cloud-flow runs (diagnose entry "
    ...
    def _validate_artifact_impl(args: dict) -> str:
        ...
        # Gate decisions go to stderr so a failing run's log shows WHY an
    ...
    validate_artifact_spec = EngineToolSpec(
        ...
        description=(
            "Offer gate. Validate a drafted artifact (dev_ticket | "
