...
def _hosted_tool_calls(response: Any) -> list[tuple[str, str, str, int]]:
    ...
    `function_call` counter misses them entirely, which is why the context and
    knowledge specialists logged "0 tool calls" even while searching heavily.
    ...
    of being invisible (the recurring customer-email-not-found wall)."""
