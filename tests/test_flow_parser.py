...
No LLM, no live tenant. The fixture is a known-good clientdata document, so
any drift in the parser is caught here before it leaks into edges.
"""
...
# A representative clientdata document: a Dataverse trigger plus an update
# action with plain columns and a lookup bind.
